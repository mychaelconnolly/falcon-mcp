...
| [Dashboards](/falcon-mcp/modules/dashboards/) | `ngsiem-dashboards:read`, `ngsiem-dashboards:write` | Reading and creating NGSIEM dashboards from LogScale dashboard YAML templates |
